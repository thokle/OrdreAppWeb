...
#Region " Web Form Designer Generated Code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.da.TableMappings.AddRange(New System.Data.Common.DataTableMapping() {New System.Data.Common.DataTableMapping("Table", "tblSekundaerKommuner", New System.Data.Common.DataColumnMapping() {New System.Data.Common.DataColumnMapping("BladId", "BladId"), New System.Data.Common.DataColumnMapping("Kommune", "Kommune")})})
    '
    'SqlInsertCommand1
    '
    Me.SqlInsertCommand1.CommandText = "INSERT INTO tblSekundaerKommuner(BladId, Kommune) VALUES (@BladId, @Kommune); SEL" & _
    "ECT BladId, Kommune FROM tblSekundaerKommuner"
    ...
    'SqlSelectCommand1
    '
    Me.SqlSelectCommand1.CommandText = "SELECT BladId, Kommune FROM tblSekundaerKommuner WHERE (BladId = @BladID)"
...
#End Region
  ...
  Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    If Not IsPostBack Then
      ...
      'End If
      SekLink.NavigateUrl = "PrimaerKommuner.aspx?BladID=" & BladID & "&chk=" & checkSum
  ...
  Private Sub grdPrim_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles grdPrim.DeleteCommand
    Try
      SqlComm.CommandText = "DELETE FROM tblSekundaerKommuner WHERE (BladID=" & BladID & ") AND (Kommune='" & CStr(e.Item.Cells(0).Text) & "')"
      SqlConn.Open()
  ...
  Private Sub btnAddPostNr_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddPostNr.Click
    Try
      SqlComm.CommandText = "INSERT INTO tblSekundaerKommuner (BladID, Kommune) VALUES (" & BladID & ",'" & CStr(txtSekuKom.Text) & "')"
      SqlConn.Open()
      SqlComm.ExecuteNonQuery()
      ShowOrdrer()
    Catch ex As Exception
