...
namespace OrdreApp
{
    public partial class SekuKommune : Page
    {
        public SekuKommune()
        {
            base.Init += Page_Init;
        ...
        private void InitializeComponent()
        {
            ...
            da.TableMappings.AddRange(new System.Data.Common.DataTableMapping[] { new System.Data.Common.DataTableMapping("Table", "tblSekundaerKommuner", new System.Data.Common.DataColumnMapping[] { new System.Data.Common.DataColumnMapping("BladId", "BladId"), new System.Data.Common.DataColumnMapping("Kommune", "Kommune") }) });
            // 
            // SqlInsertCommand1
            // 
            SqlInsertCommand1.CommandText = "INSERT INTO tblSekundaerKommuner(BladId, Kommune) VALUES (@BladId, @Kommune); SEL" + "ECT BladId, Kommune FROM tblSekundaerKommuner";
            ...
            // SqlSelectCommand1
            // 
            SqlSelectCommand1.CommandText = "SELECT BladId, Kommune FROM tblSekundaerKommuner WHERE (BladId = @BladID)";
        ...
        private void grdPrim_DeleteCommand(object source, DataGridCommandEventArgs e)
        {
            try
            {
                SqlComm.CommandText = "DELETE FROM tblSekundaerKommuner WHERE (BladID=" + BladID + ") AND (Kommune='" + e.Item.Cells[0].Text + "')";
                SqlConn.Open();
        ...
        private void btnAddPostNr_Click(object sender, EventArgs e)
        {
            try
            {
                SqlComm.CommandText = "INSERT INTO tblSekundaerKommuner (BladID, Kommune) VALUES (" + BladID + ",'" + txtSekuKom.Text + "')";
                SqlConn.Open();
                SqlComm.ExecuteNonQuery();
                ShowOrdrer();
            }
